"""
Django settings for MiProyecto1 project.
...
SECRET_KEY = 'django-insecure-x0#h%mnjy8&)u4+)#a!d-tb7sd8lr#@@^6nnn0&5hej%s%!shz'
...
WSGI_APPLICATION = 'MiProyecto1.wsgi.application'
